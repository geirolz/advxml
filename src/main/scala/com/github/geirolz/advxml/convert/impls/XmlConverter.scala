...
object XmlConverter {
  ...
  /**
    ...
    * Because the conversion can fail the output is wrapped into cats [[com.github.geirolz.advxml.validate.ValidatedEx]] in order to handle the errors
    *
    * @see [[com.github.geirolz.advxml.convert.impls.ValidatedConverter.ValidatedConverter]] for further information.
  ...
  /**
    ...
    * @return [[com.github.geirolz.advxml.validate.ValidatedEx]] instance that, if on success case contains `X` instance.
    */
  ...
  /**
    ...
    * @return [[com.github.geirolz.advxml.validate.ValidatedEx]] instance that, if on success case contains `O` instance.
    */
