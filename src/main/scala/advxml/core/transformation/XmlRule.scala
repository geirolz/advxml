package advxml.core.transformation

import advxml.core.transformation.actions.{ComposableXmlModifier, FinalXmlModifier, XmlModifier}
...
private[transformation] sealed trait ModifierComposableXmlRule {
