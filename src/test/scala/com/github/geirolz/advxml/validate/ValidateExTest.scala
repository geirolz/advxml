...
class ValidateExTest extends FunSuite with ValidatedExAssertsSet {
...
class ValidateExSyntaxTest extends FunSuite with ValidatedExAssertsSet {

  import com.github.geirolz.advxml.implicits.validate._
...
private[validate] sealed trait ValidatedExAssertsSet {
