...
//=================================== HELPERS ============================================
private[core] sealed abstract class FixedBiConverterOps[F[_]: Applicative, C[-A, B] <: Converter[
  A,
  F[B]
]] {
...
private[core] sealed abstract class FixedLeftConverterOps[F[_]: Applicative, A, CR[B] <: Converter[
  A,
  F[B]
]] {
...
private[core] sealed abstract class FixedRightConverterOps[F[_]: Applicative, B, CL[A] <: Converter[
  A,
  F[B]
]] {
